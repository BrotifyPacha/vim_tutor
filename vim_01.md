...
как почти год. Я использую его как **Php/Python** ide, и помимо чистого Vim,
...
что в регулярных выражениях он используется для обозначения начала строки.
...
Но если вам прямо не терпится, то вот клавиши пользуясь которыми можно *"побегать"*
по файлу:  
`w` , `W` , `b` , `B` , `gg` , `G` , `{` , `}` .
